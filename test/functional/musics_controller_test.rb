...
class MusicsControllerTest < ActionController::TestCase
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post :create, music: { comments: @music.comments, format: @music.format, genre: @music.genre, rating: @music.rating, title: @music.title, tracks: @music.tracks, year: @music.year }
    end
  ...
  test "should update music" do
    put :update, id: @music, music: { comments: @music.comments, format: @music.format, genre: @music.genre, rating: @music.rating, title: @music.title, tracks: @music.tracks, year: @music.year }
    assert_redirected_to music_path(assigns(:music))
  end
